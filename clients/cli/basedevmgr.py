...
from view.view_basedevmgr import ViewBaseDevMgr
import message.mds_pb2 as msg_mds
from pdsframe import *

class BaseDevMgr(BaseMgr):
    def __init__(self, srv=None, params={}):
        self.srv  = srv
        self.opt  = cmd_option['basedev']
        self.view = ViewBaseDevMgr(self.srv)    # 注册视图类

    def cli_list(self, params = {}):
        request = MakeRequest(msg_mds.GET_BASEDEV_LIST_REQUEST)
